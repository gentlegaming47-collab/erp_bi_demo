...
class PendingPurchaseRequisitionForLocationController extends Controller
{
    public function manage(){
        return view('manage.manage-pending_purchase_requisition_for_location');
    }

    public function index(PurchaseRequisition $PurchaseRequisition,Request $request,DataTables $dataTables)
    {
        ...
        if($pr_mr_detail_id != null){           
            ...
            'material_request.mr_id','locations.location_name','material_request_details.mr_qty', 
            ]) 
        ...
        // if($request->item_id !=''){
        //     $mrData->where('material_request_details.item_id', '=', $request->item_id);
        // }
        // if($request->location_id !=''){
        //     $mrData->where('locations.id','like', "%{$request->location_id}%");
        // }
        // if($request->mr_number !=''){
        //     $mrData->where('material_request.mr_number','like', "%{$request->mr_number}%");
        // }
