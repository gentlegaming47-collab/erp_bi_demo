   ...
   <div aria-hidden="false" aria-labelledby="stateLabel" role="dialog" class="modal over-over hide fade in change_state_modal" id="dealeragreementModal">

    <div class="modal-header">
            <button aria-hidden="true" data-dismiss="modal" class="close" type="button">&times;</button>

        <h3 class="modal-title" id="dealeragreementModalLabel"><flabel>Add</flabel> Dealer Agreement Details</h3>
        ...
        <form id="agreement_form" class="stdform" name="agreement_form" method="post">      
            ...
            <input type="hidden" name="agree_end_min_date" id="agree_end_min_date" />
                    ...
                    <div class="row">
                        ...
                        <div class="span-6">
                            <div class="par control-group form-control">
                                <label class="control-label" for="agreement_document">Agreement Document </label>
                                <div class="controls">
                                    <span class="formwrapper">
    ...
    <div class="modal-footer">
        <button class="btn btn-primary" id="agreement_form" type="submit" form="agreement_form" tabindex="0"><slabel>Add</slabel></button>
