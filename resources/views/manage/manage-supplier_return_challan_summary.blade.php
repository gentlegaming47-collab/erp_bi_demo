@extends('layouts.app',['pageTitle' => 'Supplier Return Challan Summary'])
...
<ul class="breadcrumbs">
    ...
    <li>Supplier Return Challan Summary</li>
</ul>
@endsection
...
<div class="widgetbox">
    <div class="headtitle">
        ...
        <h4 class="widgettitle">Supplier Return Challan Summary</h4>
    </div>
...
jQuery(document).ready(function() {
    ...
    jQuery('#export-excel').on('click',function(){
        jQuery('.supplier_return_challan_summary').click();
    });
         setTimeout(() => {
            // DataYearWise();
            loadDataTable();
    ...
    function loadDataTable(){
            ...
            jQuery('#dyntable').DataTable({
                ...
                [
                    {
                        extend:'excel',
                        filename: 'Supplier Return Challan Summary',
                        title:"",
                        className: 'supplier_return_challan_summary d-none',
                        exportOptions: {
                            columns: ':not(.export)',
                ...
                ajax: {
                        url: "{{ route('listing-supplier_return_challan_summary') }}",
                        type: "POST",
                        headers: headerOpt,
                        data : {
                ...
                columns:[
                            { data: 'src_number' ,name: 'supplier_rejection_challan.src_number' , },
                            { data: 'src_date' ,name: 'supplier_rejection_challan.src_date' ,},
                            { data: 'src_type_value_fix' ,name: 'supplier_rejection_challan.src_type_value_fix' ,},
                            { data: 'supplier_name' ,name: 'suppliers.supplier_name' ,},
                            { data: 'ref_no' ,name: 'supplier_rejection_challan.ref_no' ,},
                            { data: 'ref_date' ,name: 'supplier_rejection_challan.ref_date' ,},
                            { data: 'item_code', name: 'items.item_code' },
                            { data: 'challan_qty', name: 'supplier_rejection_challan_details.challan_qty' },
                            { data: 'unit_name', name: 'units.unit_name' },
                            { data: 'remarks', name: 'supplier_rejection_challan_details.remarks' },
                            { data: 'transporter_name', name: 'transporters.transporter_name' },
                            { data: 'vehicle_no', name: 'supplier_rejection_challan.vehicle_no' },
                            { data: 'lr_no_date', name: 'supplier_rejection_challan.lr_no_date' },
                            { data: 'special_notes', name: 'supplier_rejection_challan.special_notes' },
                        ],
