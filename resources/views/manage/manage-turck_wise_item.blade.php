@extends('layouts.app',['pageTitle' => 'Truck Wise Item List'])

@section('header')
<ul class="breadcrumbs">
    <li><a href="{{ route('dashboard') }}"><i class="iconfa-home"></i></a> <span class="separator"></span></li>
    <li>Truck Wise Item List</li>
</ul>
@endsection
...
<div class="widgetbox">
    <div class="headtitle">
        <div class="btn-group">
           ...
           @if(hasAccess("truck_wise_item","add"))
           <a href="{{ route('add-truck_wise_item') }}" class="btn btn-inverse">Add</a>
           @endif
        </div>
        <h4 class="widgettitle">Truck Wise Item List</h4>
    </div>
        ...
        <table id="dyntable" class="table table-infinite table-bordered responsive table-autowidth">
            <thead>
                <tr>
                    ...
                    <th class="head0">Model Of Transport</th>
                    <th class="head0">Transporter</th>                    
                    <th calss="head0">Vehicle</th>
                    <th calss="head1">Lr. No.</th>
                    <th class="head0">Invoice No.</th>                    
                    <th class="head0">Invoice Date</th>                                        
...
ajax: {
        url: "{{ route('listing-truck_wise_item') }}",
        type: "POST",
        headers: headerOpt,
