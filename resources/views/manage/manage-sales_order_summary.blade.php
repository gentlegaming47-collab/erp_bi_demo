@extends('layouts.app',['pageTitle' => 'Sales Order Summary'])
...
<div class="widgetbox">
    <div class="headtitle">
        ...
        <h4 class="widgettitle">Sales Order Summary</h4>
    </div>
             ...
             jQuery('#dyntable').DataTable({
                ...
                //  "order": [[ 1, 'desc' ],[ 22, 'desc' ]],
                 ...
                 [
                     {
                         extend:'excel',
                         filename: 'Sales Order Summary',
                         title:"",
                         className: 'so_summary d-none',
                         exportOptions: {
                             modifier: {
                                 page: 'all'
                             }
                 ...
                 ajax: {
                         url: "{{ route('listing-sales_order_summary') }}",
                         type: "POST",
                         headers: headerOpt,
                         data : {
