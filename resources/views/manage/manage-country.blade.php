...
<div class="widgetbox">
    <div class="headtitle">
        <div class="btn-group">
           ...
           <a href="{{ route('add-country') }}" class="btn btn-inverse">Add</a>
           @endif
        </div>
        <h4 class="widgettitle">Country</h4>
    </div>
            ...
            [
                {
                    ...
                    filename: 'Country',
					title:"",
                    className: 'export_country d-none',
                    exportOptions: {
                        columns: ':not(:eq(0))',
                        modifier: {
                            page: 'all'
