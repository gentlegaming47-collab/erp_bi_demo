...
<div class="widgetbox">
    <div class="headtitle">
        <div class="btn-group">
           ...
           <a href="{{ route('add-quotation') }}" class="btn btn-inverse">Add</a>
           @endif
        </div>
        <h4 class="widgettitle">Quotation</h4>
    </div>
        ...
        <table id="dyntable" class="table table-infinite table-bordered responsive table-autowidth">
            <thead>
                <tr class="main-header">
                    ...
                    <th class="head1">Quot. No.</th>
                    
                    <th class="head0">Quot. Date</th>
    ...
    function loadDataTable() {
        ...
        table = jQuery('#dyntable').DataTable({
            ...
            columns: [
                ...
                // { data: 'quot_date', name: 'quotation.quot_date',searchable: false, },

                { data: 'customer_name', name: 'quotation.customer_name', },
                ...
                { data: 'quot_sequence' ,name: 'quotation.quot_sequence',  visible:false},  
