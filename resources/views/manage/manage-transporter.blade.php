...
<div class="widgetbox">
    <div class="headtitle">
        <div class="btn-group">
           ...
           @if(hasAccess("transporter","add"))
           <a href="{{ route('add-transporter') }}" class="btn btn-inverse">Add</a>
           @endif
        </div>
        <h4 class="widgettitle">Transporter</h4>
    </div>
        ...
        <table id="dyntable" class="table table-infinite table-bordered responsive table-autowidth">
            <thead>
                <tr class="main-header">
                    ...
                    <th class="head1">Person Mobile</th>
                    <th class="head1">Person Email</th>
                    <th class="head1">Pay. Terms</th>
...
//     jQuery('.export_transporter').click();
// });
...
jQuery('#export-2').on('click', function() {
    ...
    var url = "{{ route('export-Transporter') }}";
            ...
            [
                {
					...
					title:"",
                    className: 'export_transporter d-none',
                    exportOptions: {
                        columns: ':not(:eq(0))',
                        modifier: {
                            page: 'all'
...
columns: [
    ...
    { data: 'approval_status', name: 'transporters.approval_status', },
    { data: 'last_by_user_id', name: 'last_by_user_id', },
    { data: 'last_on', name: 'transporters.last_on', },
    { data: 'created_by_user_id', name: 'created_by_user_id', },
    { data: 'created_on', name: 'transporters.created_on', }
],
