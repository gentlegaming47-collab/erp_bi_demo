        ...
        <table id="dyntable" class="table table-infinite table-bordered responsive table-autowidth">
            <thead>
                <tr class="main-header">
                    ...
                    <th class="head0">Challan No.</th>
                    <th class="head0">Challan Date </th>                    
                    <th class="head0">Challan Type</th>
                    <th class="head0">Supplier</th>
                    <th class="head0">GRN No. </th>
                    <th class="head0">GRN Date  </th>
                    {{-- <th calss="head1">Item </th>
                    <th calss="head1">Code</th>                    
                    <th calss="head1">Group</th>                    
...
jQuery(document).ready(function() {
    ...
    jQuery('#export-excel').on('click',function(){
        jQuery('.export_supplier_rejection').click();
    });
    loadDataTable();
    ...
    function loadDataTable() {
        ...
        buttons:
            [
                {
                    extend:'excel',
                    filename: 'Supplier Return Challan',
                    title:"",
                    className: 'export_supplier_rejection d-none',
                    exportOptions: {
