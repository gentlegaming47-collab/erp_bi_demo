...
<div class="widgetbox">
    <div class="headtitle">
        <div class="btn-group">
           ...
           @if(hasAccess("po_approval","add"))
           <a href="{{ route('add-po_approval') }}" class="btn btn-inverse">Add</a>
           @endif
        </div>
        <h4 class="widgettitle">PO Approval</h4>
    </div>
    <div class="widgetcontent overflow-scroll">
        <form id="poapprovalSearchForm" name="poapprovalSearchForm" class="stdform">
            <div class="row">
                <div class="span-6">
...
jQuery('#export-excel').on('click',function(){
    jQuery('.export_po_approval').click();
});
 loadDataTable();
    jQuery(document).on('change', '#trans_from_date, #trans_to_date', function () {
      ...
      function loadDataTable() {
        ...
        var data = new FormData(document.getElementById('poapprovalSearchForm'));
    ...
    // "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],  
        ...
        buttons:
            [
                {
                    extend:'excel',
                    filename: 'PO Approval',
                    title:"",
                    className: 'export_po_approval d-none',
                    exportOptions: {
    ...
    columns: [
        ...
        // { data: 'ref_no', name: 'purchase_order.ref_no', },
        // { data: 'ref_date', name: 'purchase_order.ref_date', },
...
jQuery("#poapprovalSearchForm").validate({
        onkeyup: false,
        onfocusout: false,
        rules: {
            trans_from_date: {
        ...
        submitHandler: function(form) {
            var searchForm = jQuery('#poapprovalSearchForm');
            loadDataTable();
