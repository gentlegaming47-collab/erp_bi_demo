...
<div class="widgetbox">
    <div class="headtitle">
        <div class="btn-group">
           ...
           @if(hasAccess("sales_return","add"))
           <a href="{{ route('add-sales_return') }}" class="btn btn-inverse">Add</a>
           @endif
        </div>
        <h4 class="widgettitle">Sales Return</h4>
    </div>
        ...
        <table id="dyntable" class="table table-infinite table-bordered responsive table-autowidth">
            <thead>
                <tr class="main-header">
                    ...
                    <th class="head0" style="display:none;">SR Sequence</th>
...
jQuery(document).ready(function() {
    ...
    jQuery('#export-excel').on('click',function(){
        jQuery('.export_sales_return').click();
    });
    loadDataTable();
    ...
    function loadDataTable() {
                ...
                [
                    {
                        ...
                        title:"",
                        className: 'export_sales_return d-none',
                        exportOptions: {
        ...
        ajax: {
                url: "{{ route('listing-sales_return') }}",
                type: "POST",
                headers: headerOpt,
                data: {
        ...
        columns: [
            ...
            // { data: 'sr_date', name: 'sales_return.sr_date',searchable: false, },

            // { data: 'sr_from_value_fix', name: 'sr_from_value_fix', },
            ...
            { data: 'last_on', name: 'sales_return.last_on', },

            { data: 'created_by_user_id', name: 'created_by_user_id', },

            { data: 'created_on', name: 'sales_return.created_on', },

            { data: 'sr_sequence' ,name: 'sales_return.sr_sequence',  visible:false},  
