@extends('layouts.app',['pageTitle' => 'GRN Summary (Location)'])
...
<div class="widgetbox">
    <div class="headtitle">
        ...
        <h4 class="widgettitle">GRN Summary (Location)</h4>
    </div>
...
jQuery(document).ready(function() {
    ...
    function loadDataTable(){
            ...
            jQuery('#dyntable').DataTable({
                ...
                ajax: {
                        url: "{{ route('listing-grn_summary_location') }}",
                        type: "POST",
                        headers: headerOpt,
                        data : {
