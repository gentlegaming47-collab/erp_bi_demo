...
<div class="widgetbox">
    <div class="headtitle">
        <div class="btn-group">
            ...
            {{-- <a href="{{ route('export-City') }}" class="btn btn-inverse pre2">Export</a> --}}
           @if(hasAccess("district","add"))
           <a href="{{ route('add-district') }}" class="btn btn-inverse">Add</a>
           @endif
        </div>
        <h4 class="widgettitle">District</h4>
    </div>
            ...
            [
                {
                    ...
                    filename: 'District',
					title:"",
                    className: 'export_district d-none',
                    exportOptions: {
                        columns: ':not(:eq(0))',
                        modifier: {
                            page: 'all'
...
columns: [
    ...
    { data: 'last_on',name: 'districts.last_on',  },
    { data: 'created_by_user_id',name: 'created_by_user_id', },
    { data: 'created_on',name: 'districts.created_on',  },
],
