...
<div class="widgetbox">
    <div class="headtitle">
        <div class="btn-group">
           ...
           @if(hasAccess("cr_decision","add"))
           <a href="{{ route('add-cr_decision') }}" class="btn btn-inverse">Add</a>
           @endif
        </div>
        <h4 class="widgettitle">CR Decision</h4>
    </div>
        ...
        <table id="dyntable" class="table table-infinite table-bordered responsive table-autowidth">
            <thead>
                <tr>
                    ...
                    <th class="head0">Scrap/Store</th>                    
                    <th class="head0">CR No.</th>                    
                    <th class="head0">CR Date</th>                    
                    <th class="head0">Customer</th>                                        
                    <th class="head0">Item Name</th>                                        
                    <th class="head0">Item Code</th>                                        
                    <th class="head0">Ref. Qty</th>                                        
                    <th class="head0">Pending Decision Qty</th>                                  
