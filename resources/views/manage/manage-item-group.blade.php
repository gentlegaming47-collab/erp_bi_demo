...
<div class="widgetbox">
    <div class="headtitle">
        <div class="btn-group">
           ...
           <a href="{{ route('add-item_group') }}" class="btn btn-inverse">Add</a>
           @endif
        </div>
...
columns: [
    ...
    { data: 'item_group_code', name: 'item_groups.item_group_code', },
    { data: 'last_by_user_id', name: 'last_by_user_id', },
    { data: 'last_on', name: 'item_groups.last_on', },
    { data: 'created_by_user_id', name: 'created_by_user_id', },
    { data: 'created_on', name: 'item_groups.created_on', }
],
