@extends('layouts.app',['pageTitle' => 'Pending SO for Dispatch (SO Wise)'])
...
<ul class="breadcrumbs">
    ...
    <li>Pending SO for Dispatch (SO Wise)</li>
</ul>
@endsection
...
<div class="widgetbox">
    <div class="headtitle">
        ...
        <h4 class="widgettitle">Pending SO for Dispatch (SO Wise)</h4>
    </div>
    <div class="widgetcontent overflow-scroll">
            <form id="psfdswSearchForm" name="psfdswSearchForm" class="stdform">
                <div class="row">
                    <div class="span-6">
...
jQuery(document).ready(function() {
    ...
    function loadDataTable(){
            ...
            var data = new FormData(document.getElementById('psfdswSearchForm'));
            ...
            table = jQuery('#dyntable').DataTable({
                ...
                "order": [[ 2, 'asc' ],[15 , 'asc']], // date wise asc
                pageLength : 25,
                dom: 'Blfrtip',
                buttons:
                [
                    {
                        extend:'excel',
                        filename: 'Pending SO For Dispatch (SO Wise)',
                        title:"",
                        className: 'psfd d-none',
                        exportOptions: {
                            columns: function(idx, data, node) {
                                return idx !== 0 && idx !== 15 && table.columns(idx).visible();
                            },
                            // columns: ':not(:eq(0))',
                            modifier: {
                                page: 'all'
                ...
                ajax: {
                        url: "{{ route('listing-pending_so_for_dispatch_so_wise_report') }}",
                        type: "POST",
                        headers: headerOpt,
                        data : {
                ...
                columns: [
                    ...
                    //  { data: 'pend_so_qty', name: 'pend_so_qty', searchable: false, orderable: false },
    ...
    jQuery("#psfdswSearchForm").validate({
         onkeyup: false,
        onfocusout: false,
        rules: {
    ...
    // search form logic
     ...
     jQuery('#reset-order-data').on('click',function(){
        var searchForm = jQuery("#psfdswSearchForm");
