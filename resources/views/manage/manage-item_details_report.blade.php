@extends('layouts.app',['pageTitle' => 'Item Details Report'])
...
<div class="widgetbox">
    <div class="headtitle">
        <div class="btn-group">
           @if(hasAccess("item_details_report","print"))
        ...
        <h4 class="widgettitle">Item Details Report</h4>
    </div>
        ...
        <table id="dyntable" class="table table-infinite table-bordered responsive table-autowidth">
            <thead>
                <tr class="main-header">
                    ...
                    <th class="head0 report-stocklabel">Primary Stock Qty.</th>
                    <th class="head0 report-stocklabel">Primary Unit</th>
                    <th class="head0 report-stocklabel">Secondary Stock Qty.</th>
                    <th class="head0 report-stocklabel">Secondary Unit</th>
...
//  "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],  
    ...
    buttons:
            [
                {
                    extend:'excel',
                    filename: 'Item Details Stock Report',
					title:"",
...
ajax: {
        url: "{{ route('listing-item_details_report') }}",
        type: "POST",
        headers: headerOpt,
...
columns: [
    ...
    { data: 'stock_qty' ,name: 'location_stock_details.stock_qty' ,},
    { data: 'unit_name' ,name: 'units.unit_name' , },
    { data: 'secondary_stock_qty' ,name: 'location_stock_details.secondary_stock_qty' , },
    { data: 'second_unit' ,name: 'seond_units.unit_name' , },
