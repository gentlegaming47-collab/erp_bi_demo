@extends('layouts.app',['pageTitle' => 'Item Return Slip Summary'])
...
<ul class="breadcrumbs">
    ...
    <li>Item Return Slip Summary</li>
</ul>
@endsection
...
<div class="widgetbox">
    <div class="headtitle">
        ...
        <h4 class="widgettitle">Item Return Slip Summary</h4>
    </div>
    <div class="widgetcontent overflow-scroll">
            {{-- <form id="irssSearchForm" name="irssSearchForm" class="stdform"> --}}
                ...
                {{-- <div class="row">
                    ...
                    <div class="span-6">
                        <div class="par control-group form-control">
                                <label class="control-label" for="return_number">Ret. No.</label>
                                <span class="formwrapper">
                                    <input type="text" name="return_number" id="return_number" onkeyup="suggestReturnNumber(event,this)" class="form-control" autocomplete="nope"/>
                                    <div id="return_number_list" class="suggestion_list" ></div>
                                </span>
                        </div>
                    </div>
                    <div class="span-6">
                ...
                <div class="row">
                    <div class="span-6">
                        <div class="par control-group form-control">
                                ...
                                <span class="formwrapper">
                                    <input type="text" name="issue_no" id="issue_no" onkeyup="suggestIssueNo(event,this)" class="form-control" autocomplete="nope"/>
                                    <div id="issue_no_list" class="suggestion_list" ></div>
                                </span>
                        </div>
                    </div>
            ...
            <table id="dyntable" class="table table-infinite table-bordered responsive table-autowidth">
                <thead>
                    <tr class="main-header">
                        <th class="head0">Ret. No.</th>
                        <th class="head0">Ret. Date</th>
                        <th class="head0">Issue No. </th>
                        <th class="head0">Item</th>
                        <th class="head0">Code</th>
                        <th class="head0">Ret. Qty.</th>
...
jQuery(document).ready(function() {
    ...
    jQuery('#export-excel').on('click',function(){
        jQuery('.item_return_slip_summary').click();
    });
         setTimeout(() => {
            DataYearWise();
            loadDataTable();
    ...
    function loadDataTable(){
            ...
            jQuery('#dyntable').DataTable({
                ...
                [
                    {
                        extend:'excel',
                        filename: 'Item Return Slip Summary',
                        title:"",
                        className: 'item_return_slip_summary d-none',
                        exportOptions: {
                            modifier: {
                                page: 'all'
                            }
                ...
                ajax: {
                        url: "{{ route('listing-item_return_slip_summary') }}",
                        type: "POST",
                        headers: headerOpt,
                        data : {
                                ...
                                // 'return_number': formValue.return_number,
                                // 'item_id': formValue.item_id,
                                // 'issue_number': formValue.issue_no,
