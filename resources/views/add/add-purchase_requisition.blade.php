...
<ul class="breadcrumbs">
    ...
    <li>Add Purchase Requisition</li>
</ul>
@endsection
@section('content')
...
<div class="widgetbox">
  <div class="headtitle">
    ...
    <h4 class="widgettitle">Add Purchase Requisition</h4>
  </div>
            ...
            <div class="par control-group form-control">
                ...
                <div class="controls">
                        <span class="formwrappers">
                            <button type="submit" class="btn btn-primary" id="PrButton">{{ config('define.value.add') }}</button>
                </div>
            </div>
        </div>
