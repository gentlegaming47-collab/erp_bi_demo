...
<div class="widgetbox">
    ...
    <div class="headtitle">
        ...
        <div class="btn-group">
           ...
           <a href="{{ route('manage-item_stock_transfer') }}" class="btn btn-inverse">Back</a>

        </div>

        <h4 class="widgettitle">Add Item Stock Transfer</h4>
                    ...
                    <div class="par control-group form-control">
                        ...
                        <div class="controls">
                                <span class="formwrapper"> 
                                    <button type="submit" class="btn btn-primary" id="ist_btn">{{ config('define.value.add') }}</button>
                                </span>
                        </div>
                    </div>
                </div>
