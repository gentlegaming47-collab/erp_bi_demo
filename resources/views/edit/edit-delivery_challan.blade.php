...
<div class="widgetbox">
  <div class="headtitle">
    ...
    <h4 class="widgettitle">Edit Delivery Challan</h4>
  </div>
            ...
            <div class="par control-group form-control">
                ...
                <div class="controls">
                        <span class="formwrappers">
                            <button type="submit" class="btn btn-primary" id="delivery_challan_button">Update</button>
