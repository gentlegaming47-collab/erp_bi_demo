...
<ul class="breadcrumbs">
    ...
    <li><a href="{{ route('add-customer_replacement_entry') }}">Replacement Item Decision</a> <span class="separator"></span></li>

    <li>Edit Replacement Item Decision</li>
...
<div class="widgetbox">
    ...
    <div class="headtitle">
        ...
        <div class="btn-group">
           ...
           <a href="{{ route('manage-replacement_item_decision') }}" class="btn btn-inverse">Back</a>

        </div>

        <h4 class="widgettitle">Edit Replacement Item Decision</h4>
