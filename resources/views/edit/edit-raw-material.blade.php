...
<div class="widgetbox">
    <div class="headtitle">
        ...
        <h4 class="widgettitle">Edit Raw Material</h4>
    </div>
                    ...
                    <div class="par control-group">
                        ...
                        <div class="controls">
                            ...
                            <span class="formwrapper">
                                ...
                                <input type="text" name="raw_material" id="raw_material" class="input-large auto-suggest" onkeyup="suggestRawMaterial(event,this)" autocomplete="nope" autofocus/>
                    ...
                    <div class="par control-group">
                        ...
                        <div class="controls">
                            ...
                            <span class="formwrapper">
                                ...
                                <input type="text" name="min_stock_qty" id="min_stock_qty"  class="input-large auto-suggest mobile-f" autocomplete="nope" autofocus/>
                    ...
                    <div class="par control-group">
                        ...
                        <div class="controls">
                            ...
                            <span class="formwrapper">
                                ...
                                <input type="text" name="max_stock_qty" id="max_stock_qty" class="input-large auto-suggest mobile-f" autocomplete="nope" autofocus/>
                    ...
                    <div class="par control-group">
                        ...
                        <div class="controls">
                            ...
                            <span class="formwrapper">
                                ...
                                <input type="text" name="re_order_qty" id="re_order_qty" class="input-large auto-suggest mobile-f" autocomplete="nope" autofocus/>
                    ...
                    <div class="par control-group">
                        ...
                        <div class="controls">
                            ...
                            <span class="formwrapper">
                                ...
                                <input type="text" name="rate_per_unit" id="rate_per_unit"  class="input-large auto-suggest allow_decimal" autocomplete="nope" autofocus/> &nbsp;&nbsp;Rs.
...
jQuery.ajax({
    ...
    url: "{{ route('get-raw-materials',['id' => base64_decode($id) ]) }}",
    ...
    success: function (data) {
        ...
        if(data.response_code == 1){
           ...
           var thisForm =  jQuery('#editRawMaterialform');
             ...
             thisForm.find('#raw_material').val(data.raw_material.raw_material);

            thisForm.find('#raw_material_group_id').val(data.raw_material.raw_material_group_id).trigger("liszt:updated").trigger('change');

         

            thisForm.find('#unit_id').val(data.raw_material.unit_id).trigger("liszt:updated").trigger('change');

            thisForm.find('#min_stock_qty').val(data.raw_material.min_stock_qty);

            thisForm.find('#max_stock_qty').val(data.raw_material.max_stock_qty);

            thisForm.find('#re_order_qty').val(data.raw_material.re_order_qty);

            thisForm.find('#hsn_code').val(data.raw_material.hsn_code).trigger("liszt:updated").trigger('change');

            thisForm.find('#rate_per_unit').val(data.raw_material.rate_per_unit);

        

            // if(data.raw_material.id == 1)
            // {
			...
			jAlert(data.response_message, 'Alert Dialog', function(r) {
				window.location.href = "{{ route('manage-raw_material')}}";
			});
